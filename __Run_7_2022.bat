echo off 
REM 2017
REM SET PATH=%PATH%;C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Tools\MSVC\14.16.27023\bin
REM 2017
REM call "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\Common7\Tools\VsDevCmd.BAT" 

REM 2022
SET PATH=%PATH%;C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.36.32532\bin\Hostx86\x86
echo on
...
cl.exe /EHsc /std:c17 x86utm.cpp api.c decode.c mem.c ops.c ops2.c prim_ops.c
...
cl  /GS- /FA /FaHalt7.asm /std:c17 /c /arch:IA32 Halt7.c 
if ERRORLEVEL 1 pause
